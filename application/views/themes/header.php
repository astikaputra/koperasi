...
<html lang="en">
  ...
  <body>
    ...
    <!-- Begin page content glyphicon glyphicon-ok-->
<div class="container">
...
// If cart is empty, this will show below message.
 ...
 ?>
      ...
      <!-- <div class="list-group">
           <a href="" class="list-group-item"><strong><i class="glyphicon glyphicon-shopping-cart"></i> ORDER SIAP DI AMBIL </strong></a>
           <?php
                foreach ($nama as $row) 
            {
      ?>
            <a class="list-group-item"><?php echo $row['nama'];?></a>
            <?php
            }
      ?>  
        </div>
